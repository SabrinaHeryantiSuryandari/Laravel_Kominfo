    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
          ...
          <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo" href="index.html"><img src="{{ asset('img/logo-kominfo.png') }}" class="mr-5" alt="logo" width="150px"/></a>
            <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{ asset('img/kominfo.png') }}" alt="logo"/></a>
          </div>
              ...
              <ul class="nav">
                ...
                {{-- <li class="nav-item">
                  ...
                  <div class="collapse" id="auth">
                    <ul class="nav flex-column sub-menu">
                      <li class="nav-item"> <a class="nav-link" href="/pengguna"> Lihat Akun </a></li>
                      <li class="nav-item"> <a class="nav-link" href="/"> Buat Akun </a></li>
                    </ul>
                  </div>
                </li> --}}
        ...
        {{-- <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                <li class="nav-item">
                    <a class="nav-link" href="{{ asset('template1/index.html') }}">
                    <i class="icon-grid menu-icon"></i>
                    <span class="menu-title">Dashboard</span>
                    </a>
                </li>
